...
MEMORY_BUCKET = "okada-claude3-memory"
PROMPT_BUCKET = "oakda-claude3-prompt"
IMAGE_BUCKET = "okada-claude3-image"
memory_bucket = s3.Bucket(MEMORY_BUCKET)
prompt_bucket = s3.Bucket(PROMPT_BUCKET)
image_bucket = s3.Bucket(IMAGE_BUCKET)

PROMPT_NAME = "sys_prompt.txt"
...
if __name__ == "__main__":
    ...
    message = chat("こんにちは, 私はOkadaです", "0001")
